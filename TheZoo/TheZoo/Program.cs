...
namespace TheZoo
{
    public class Program
    {
        ...
        {   // Creates  somewhere between 1 and 6(maxNum not included) Animal of each subclass 
            ...
            if (retVal.Count == 0) { Console.WriteLine("We have a problem with creating animals"); return retVal; }
            else { return retVal; }
        ...
        {// Creates  somewhere between 3 and maxEmployees(maxNum not included)of Employees
            ...
            if (retVal.Count == 0) { Console.WriteLine("We have a problem with creating employees"); return retVal; }
            else { return retVal; }
