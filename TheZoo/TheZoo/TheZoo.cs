    ...
    public class TheZoo
    {
        ...
        public TheZoo(List<Animal> allAnimals, List<Employee> allEmployees,FoodStorage foodStorage, TicketOffice ticketOffice)
        {
            ...
            this._allAnimals.ForEach(animal => {
                animal.EventHungryAnimal += OnEventHungryAnimal;
                animal.IsdailyNeedSatisfyed();
            });

            jobAppointer.Cashier.VisitorEntering += OnVisitorEntering;
            jobAppointer.Cashier.CallingAdminToTheTicketOffice += ONCallingAdminToTheTicketOffice;
        }
        ...
        private void OnVisitorEntering (Object sender, TheZooJobEventArgs args)
        {
            ...
            {
                AllVisitors.Add(visitorWithATicket);
            }
        ...
        private void ONCallingAdminToTheTicketOffice(Object sender,TheZooJobEventArgs args)
        {
            ...
            Employee admin = ReturnRandomEmployee(EmployeeRoleEnum.ADMINISTRATOR);
        ...
        {
            Employee randomWorker =  ReturnRandomEmployee(EmployeeRoleEnum.WORKER);
            if(randomWorker != null)
            {
                ...
                else
                {
                    ...
                    Employee administrator = ReturnRandomEmployee(EmployeeRoleEnum.ADMINISTRATOR);
